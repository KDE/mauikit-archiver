...
```
cd existing_repo
git remote add origin https://invent.kde.org/camiloh/mauikit-archiver.git
git branch -M master
...
- [ ] [Set up project integrations](https://invent.kde.org/camiloh/mauikit-archiver/-/settings/integrations)
